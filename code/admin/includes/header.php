    ...
    <div class="page-flex">
        ...
        <aside class="sidebar " id='barView' style="background-color:black !important;">
            ...
            <div class="sidebar-start">
                <div class="sidebar-head">
                    <div class="main-nav-start">
                        <div
                            style="font-weight:800; text-align:center;color: white;padding: 10px;display: flex;justify-content: space-between;width: 220px;">
                            <a href="../index.php" style="text-decoration: none; color:white;">ORENS STOR</a> <i
                                class="fa-solid fa-xmark" id='hide' style="font-size: 20px;" onclick="hide()"></i>
                        </div>
                    </div>
                ...
                <div class="sidebar-body">
                    <ul class="sidebar-body-menu">
                        <li>
                            <a class="active" href="./index.php"><span class="icon home"
            ...
            ?>
                        ...
                        <li>
                        <li>
                            <a href="manage_categories.php"><span class="icon folder"
                                    aria-hidden="true"></span>Categories</a>
                        </li>
                        </li>
                        <li>
                        <li>
                            <!--  -->
                            <a href="manage_products.php"><span class="icon image"
                                    aria-hidden="true"></span>Products</a>
                        </li>
                        <li>
                            <!--  -->
